export default class Popup {
  ...
  clean() {
    const errorElement1 = document.querySelector(`#error-${this.input1.name}`);
    const errorElement2 = document.querySelector(`#error-${this.input2.name}`);
